<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.content_list" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(category_id,"优为教育");
	...
	templateBuilder.Append(linkurl("content_list",Utils.ObjectToStr(cdr1["id"])));
	...
	string sub_menu = get_category_menu("content_list",category_id);
	...
	DataTable news_list = get_content_list(channel_id, category_id, 10, page, "", out totalcount);
	...
	templateBuilder.Append("\r\n                      <li>\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("content",Utils.ObjectToStr(listdr["call_index"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(listdr["title"]) + "\">" + Utils.ObjectToStr(listdr["title"]) + "</a><span>");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(listdr["add_time"])).ToString("yyyy-MM-dd"));
